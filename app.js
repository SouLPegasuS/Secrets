...
const userSchema = new mongoose.Schema({
  ...
  password: String,
  secret: [itemSchema],
  // googleId for google OAuth to findOrCreat
  googleId: String
});
...
// this serealizing is for any strategy of authentication
    ...
    User.findById(req.user.id, function(err, foundUser){
      if(err){
        ...
        if(foundUser){
          ...
          res.render("mySecrets", {currUser: foundUser});
...
app.post("/delete", function(req, res){
  User.updateOne({_id: req.user._id}, {$pull: {secret: {_id: req.body.dltBtn}}}, function(err){
    if(!err){
